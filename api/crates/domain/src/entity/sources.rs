    ...
    fn validate_succeeds_with_bluesky() {
        let source = Source {
            ...
            external_service: ExternalService {
                ...
                url_pattern: Some(r"^https?://bsky\.app/profile/(?<creatorId>[^/?#]+)/post/(?<id>[^/?#]+)(?:[?#].*)?$".to_string()),
            },
    ...
    fn validate_succeeds_with_fantia() {
        let source = Source {
            ...
            external_service: ExternalService {
                ...
                url_pattern: Some(r"^https?://fantia\.jp/posts/(?<id>\d+)(?:[?#].*)?$".to_string()),
            },
    ...
    fn validate_succeeds_with_mastodon() {
        let source = Source {
            ...
            external_service: ExternalService {
                ...
                url_pattern: Some(r"^https?://mastodon\.social/@(?<creatorId>[^/?#]+)/(?<id>\d+)(?:[?#].*)?$".to_string()),
            },
    ...
    fn validate_succeeds_with_misskey() {
        let source = Source {
            ...
            external_service: ExternalService {
                ...
                url_pattern: Some(r"^https?://misskey\.io/notes/(?<id>[^/?#]+)(?:[?#].*)?$".to_string()),
            },
    ...
    fn validate_succeeds_with_nijie() {
        let source = Source {
            ...
            external_service: ExternalService {
                ...
                url_pattern: Some(r"^https?://nijie\.info/view\.php\?id=(?<id>\d+)(?:[?#].*)?$".to_string()),
            },
    ...
    fn validate_succeeds_with_pixiv_fanbox() {
        let source = Source {
            ...
            external_service: ExternalService {
                ...
                base_url: None,
                url_pattern: Some(r"^https?://(?:(?<creatorId>[^.]+)\.fanbox\.cc|www\.fanbox\.cc/@(?:[^.]+))/posts/(?<id>\d+)(?:[?#].*)?$".to_string()),
            },
    ...
    fn validate_succeeds_with_pleroma() {
        let source = Source {
            ...
            external_service: ExternalService {
                ...
                url_pattern: Some(r"^https?://(?:[^/]+)/notice/([^/?#]+)(?:[?#].*)?$".to_string()),
            },
    ...
    fn validate_succeeds_with_seiga() {
        let source = Source {
            ...
            external_service: ExternalService {
                ...
                url_pattern: Some(r"^https?://seiga\.nicovideo\.jp/seiga/(?<id>\d+)(?:[?#].*)?$".to_string()),
            },
    ...
    fn validate_succeeds_with_threads() {
        let source = Source {
            ...
            external_service: ExternalService {
                ...
                url_pattern: Some(r"^https?://www\.threads\.net/(?<creatorId>[^/]+)/post/(?<id>[^/$#]+)(?:[?#].*)?$".to_string()),
            },
    ...
    fn validate_succeeds_with_xfolio() {
        let source = Source {
            ...
            external_service: ExternalService {
                ...
                url_pattern: Some(r"^https?://xfolio\.jp/portfolio/(?<creatorId>[^/]+)/works/(?<id>\d+)(?:[?#].*)?$".to_string()),
            },

    ...
    fn validate_succeeds_with_mastodon() {
        let source = Source {
            ...
            external_service: ExternalService {
                ...
                url_pattern: Some(r"^https?://mastodon\.social/@([^/?#]+)/(?<id>\d+)(?:[?#].*)?$".to_string()),
            },
    ...
    fn validate_succeeds_with_misskey() {
        let source = Source {
            ...
            external_service: ExternalService {
                ...
                url_pattern: Some(r"^https?://misskey\.io/notes/([^/?#]+)(?:[?#].*)?$".to_string()),
            },
    ...
    fn validate_succeeds_with_pixiv_fanbox() {
        let source = Source {
            ...
            external_service: ExternalService {
                ...
                base_url: None,
                url_pattern: Some(r"^https?://(?:([^.]+)\.fanbox\.cc|www\.fanbox\.cc/@(?<creatorId>[^.]+))/posts/(?<id>\d+)(?:[?#].*)?$".to_string()),
            },

        ...
        Medium {
            ...
            replicas: vec![
                Replica {
                    ...
                    display_order: 1,
                    thumbnail: None,
                    original_url: "file:///91626dc4-3e2a-4028-8574-8feb3c817fd1.jpg".to_string(),
                    mime_type: Some("image/jpeg".to_string()),
                    size: Some(Size::new(1280, 2048)),
                ...
                Replica {
                    ...
                    display_order: 2,
                    thumbnail: None,
                    original_url: "file:///7f0638e2-aa86-4b00-9e52-b0e803247a4b.jpg".to_string(),
                    mime_type: Some("image/jpeg".to_string()),
                    size: Some(Size::new(1280, 2048)),
                    status: ReplicaStatus::Ready,
        ...
        Medium {
            ...
            replicas: vec![
                Replica {
                    ...
                    display_order: 1,
                    thumbnail: None,
                    original_url: "file:///69f9463e-9c29-48c9-a104-23341348ffec.png".to_string(),
                    mime_type: Some("image/png".to_string()),
                    size: Some(Size::new(768, 1024)),
                    status: ReplicaStatus::Ready,
                ...
                Replica {
                    ...
                    display_order: 2,
                    thumbnail: None,
                    original_url: "file:///040d009c-70df-4f55-ae55-df6e5fc57362.png".to_string(),
                    mime_type: Some("image/png".to_string()),
                    size: Some(Size::new(768, 1024)),
                    status: ReplicaStatus::Ready,
        ...
        Medium {
            ...
            replicas: vec![
                Replica {
                    ...
                    display_order: 1,
                    thumbnail: None,
                    original_url: "file:///1524e043-a327-43ab-9a87-4e5ffa051cb7.jpg".to_string(),
                    mime_type: Some("image/jpeg".to_string()),
                    size: Some(Size::new(2500, 3500)),
                    status: ReplicaStatus::Ready,
        ...
        Medium {
            ...
            replicas: vec![
                Replica {
                    ...
                    display_order: 1,
                    thumbnail: None,
                    original_url: "file:///38505b5a-2e25-4325-8668-97cc39b57e73.png".to_string(),
                    mime_type: Some("image/png".to_string()),
                    size: Some(Size::new(1200, 2000)),
                    status: ReplicaStatus::Ready,
        ...
        Medium {
            ...
            replicas: vec![
                Replica {
                    ...
                    display_order: 1,
                    thumbnail: None,
                    original_url: "file:///9b73469d-55fe-4017-aee8-dd8f8d7d067a.jpg".to_string(),
                    mime_type: Some("image/jpeg".to_string()),
                    size: Some(Size::new(1200, 2000)),
                    status: ReplicaStatus::Ready,
                    created_at: Utc.with_ymd_and_hms(2022, 1, 2, 3, 4, 9).unwrap(),
        ...
        Medium {
            ...
            replicas: vec![
                Replica {
                    ...
                    display_order: 1,
                    thumbnail: None,
                    original_url: "file:///fc874edd-6920-477d-a070-3c28203a070f.jpg".to_string(),
                    mime_type: Some("image/jpeg".to_string()),
                    size: Some(Size::new(1280, 2048)),
                    status: ReplicaStatus::Ready,
                    created_at: Utc.with_ymd_and_hms(2022, 1, 2, 3, 4, 12).unwrap(),
        ...
        Medium {
            ...
            replicas: vec![
                Replica {
                    ...
                    display_order: 1,
                    thumbnail: None,
                    original_url: "file:///38619a8c-68c7-4bdd-b7e4-169e51b1974e.png".to_string(),
                    mime_type: Some("image/png".to_string()),
                    size: Some(Size::new(1400, 2000)),
                    status: ReplicaStatus::Ready,
                ...
                Replica {
                    ...
                    display_order: 2,
                    thumbnail: None,
                    original_url: "file:///e7f3765b-08ea-4217-a4da-4f56482c7d26.png".to_string(),
                    mime_type: Some("image/png".to_string()),
                    size: Some(Size::new(1400, 2000)),
                    status: ReplicaStatus::Ready,

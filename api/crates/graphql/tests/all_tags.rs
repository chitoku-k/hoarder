        ...
        .returning(|_, _, _, _, _, _| {
            Ok(vec![
                Tag {
                    ...
                    parent: None,
                    children: Vec::new(),
                    created_at: NaiveDate::from_ymd_opt(2022, 6, 1).and_then(|d| d.and_hms_opt(0, 4, 0)).unwrap(),
                ...
                Tag {
                    ...
                    parent: None,
                    children: Vec::new(),
                    created_at: NaiveDate::from_ymd_opt(2022, 6, 1).and_then(|d| d.and_hms_opt(0, 3, 0)).unwrap(),
                    updated_at: NaiveDate::from_ymd_opt(2022, 6, 1).and_then(|d| d.and_hms_opt(0, 4, 0)).unwrap(),
                },
                Tag {
            ...
            "edges": [
                ...
                },
                {
                    "node": {
                        ...
                        "parent": null,
                        "children": [],
                        "createdAt": "2022-06-01T00:03:00",
                        "updatedAt": "2022-06-01T00:04:00",
                    },
                },
                {
                    "node": {

...
impl<ExternalServicesRepository> ExternalServicesService<ExternalServicesRepository>
where
    ExternalServicesRepository: external_services::ExternalServicesRepository,
{
    pub async fn create_external_service(&self, slug: &str, name: &str) -> anyhow::Result<ExternalService> {
    ...
    pub async fn get_external_services(&self) -> anyhow::Result<Vec<ExternalService>> {
    ...
    pub async fn get_external_services_by_ids<T>(&self, ids: T) -> anyhow::Result<Vec<ExternalService>>
    where
    ...
    pub async fn update_external_service_by_id(&self, id: ExternalServiceId, name: Option<&str>) -> anyhow::Result<ExternalService> {
    ...
    pub async fn delete_external_service_by_id(&self, id: ExternalServiceId) -> anyhow::Result<DeleteResult> {

            ...
            .returning(|_, _, _, _, _, _, _| {
                Ok(vec![
                    media::Medium {
                        ...
                        replicas: Vec::new(),
                        created_at: NaiveDate::from_ymd(2022, 6, 1).and_hms(12, 34, 56),
                        updated_at: NaiveDate::from_ymd(2022, 6, 1).and_hms(0, 5, 0),
                    },
                    media::Medium {
                        ...
                        replicas: Vec::new(),
                        created_at: NaiveDate::from_ymd(2022, 6, 1).and_hms(12, 34, 57),
                        updated_at: NaiveDate::from_ymd(2022, 6, 1).and_hms(0, 5, 1),
                    },
                    media::Medium {
                        ...
                        replicas: Vec::new(),
                        created_at: NaiveDate::from_ymd(2022, 6, 1).and_hms(12, 34, 58),
                        updated_at: NaiveDate::from_ymd(2022, 6, 1).and_hms(0, 5, 2),
                    },
                    media::Medium {
                        ...
                        tags: BTreeMap::new(),
                        replicas: Vec::new(),
                        created_at: NaiveDate::from_ymd(2022, 6, 1).and_hms(12, 34, 59),
                        updated_at: NaiveDate::from_ymd(2022, 6, 1).and_hms(0, 5, 3),
                    },
                ])
            });
                    ...
                    media::Medium {
                        ...
                        replicas: vec![
                            replicas::Replica {
                                ...
                                created_at: NaiveDate::from_ymd(2022, 6, 2).and_hms(0, 0, 0),
                                updated_at: NaiveDate::from_ymd(2022, 6, 2).and_hms(0, 1, 0),
                            },
                            replicas::Replica {
                                ...
                                mime_type: "image/png".to_string(),
                                created_at: NaiveDate::from_ymd(2022, 6, 3).and_hms(0, 2, 0),
                                updated_at: NaiveDate::from_ymd(2022, 6, 3).and_hms(0, 3, 0),
                            },
                        ],
                        created_at: NaiveDate::from_ymd(2022, 6, 1).and_hms(12, 34, 56),
                        updated_at: NaiveDate::from_ymd(2022, 6, 1).and_hms(0, 5, 0),
                    ...
                    media::Medium {
                        ...
                        sources: vec![
                            ...
                            sources::Source {
                                ...
                                created_at: NaiveDate::from_ymd(2016, 5, 6).and_hms(5, 14, 0),
                                updated_at: NaiveDate::from_ymd(2016, 5, 6).and_hms(5, 14, 1),
                            },
                        ],
                        tags: BTreeMap::new(),
                        replicas: Vec::new(),
                    ...
                    media::Medium {
                        ...
                        sources: vec![
                            sources::Source {
                                ...
                                created_at: NaiveDate::from_ymd(2016, 5, 5).and_hms(7, 6, 0),
                                updated_at: NaiveDate::from_ymd(2016, 5, 5).and_hms(7, 6, 1),
                            },
                        ],
                        tags: BTreeMap::new(),
                        replicas: Vec::new(),
        ...
        media_service
            ...
            .withf(|tag_depth, replicas, sources, since, until, order, limit| {
                (tag_depth, replicas, sources, since, until, order, limit) == (
                    ...
                    &false,
                    &false,
                    &Some((NaiveDate::from_ymd(2022, 6, 1).and_hms(12, 34, 57), MediumId::from(uuid!("88888888-8888-8888-8888-888888888888")))),
                    &None,
                    &OrderDirection::Ascending,
                    &4,
                )
        ...
        media_service
            ...
            .withf(|tag_depth, replicas, sources, since, until, order, limit| {
                (tag_depth, replicas, sources, since, until, order, limit) == (
                    ...
                    &false,
                    &false,
                    &Some((NaiveDate::from_ymd(2022, 6, 1).and_hms(12, 34, 58), MediumId::from(uuid!("99999999-9999-9999-9999-999999999999")))),
                    &None,
                    &OrderDirection::Descending,
                    &4,
                )

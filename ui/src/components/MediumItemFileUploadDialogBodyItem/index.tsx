...
import { MEDIUM_REPLICA_DECODE_FAILED, MEDIUM_REPLICA_UNSUPPORTED, OBJECT_URL_INVALID, REPLICA_ORIGINAL_URL_DUPLICATE, useError, useFilesize } from '@/hooks'
...
const MediumItemFileUploadDialogBodyItem: FunctionComponent<MediumItemFileUploadDialogBodyItemProps> = ({
  ...
  const objectUrlInvalid = graphQLError(error, OBJECT_URL_INVALID)
            ...
            <>
              <Stack spacing={0.75} direction="row" alignItems="center">
                ...
                {mediumReplicaDecodeFailed ? (
                  ...
                  <Typography>エラー: ファイル名またはアップロード先が正しくありません</Typography>
